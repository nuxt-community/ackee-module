...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const hasIcon = computed(() => {
      var _a, _b;
      return ((_a = prose.h6) == null ? void 0 : _a.icon) !== false && ((_b = prose.headings) == null ? void 0 : _b.icon) !== false;
    });
    const icon = computed(() => {
      var _a, _b;
      return ((_a = prose.h6) == null ? void 0 : _a.icon) || ((_b = prose.headings) == null ? void 0 : _b.icon);
    });
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0$5;
      const _component_Icon = __nuxt_component_0$3;
      _push(`<h6${ssrRenderAttrs(mergeProps({ id: __props.id }, _attrs))} data-v-73e679c1>`);
...
const ProseH6 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-73e679c1"]]);

export { ProseH6 as default };
//# sourceMappingURL=ProseH6.1e901a8e.mjs.map
